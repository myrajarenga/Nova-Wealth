      ...
      <div className="container">
        <div className="footer-content">
          ...
          <div className="footer-column">
            ...
            <p className="footer-tagline" style={{ color: '#ddd' }}>Building lasting wealth through personalized financial strategies and expert guidance.</p>
          </div>
          ...
          <div className="footer-column">
            ...
            <ul className="footer-links">
              ...
              <li><Link to="/about#meet-our-founders" className="footer-link">Our Team</Link></li>
              <li><Link to="/faq" className="footer-link">FAQs</Link></li>
              <li><Link to="/client-center/resources" className="footer-link">Resources & Insights</Link></li>
            </ul>
          </div>
          ...
          <div className="footer-column">
            ...
            <div className="footer-social">
              <a href="#" aria-label="LinkedIn" className="social-link linkedin" target="_blank" rel="noopener noreferrer">
              ...
              <a href="#" aria-label="Twitter (X)" className="social-link twitter" target="_blank" rel="noopener noreferrer">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="#" aria-label="YouTube" className="social-link youtube" target="_blank" rel="noopener noreferrer">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
